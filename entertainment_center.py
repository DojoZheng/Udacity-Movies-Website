...
for movie in movies_data:
	...
	movies_arr.append(Movie(movie_name, movie_imageUrl, movie_url, movie_rating))

# Test the other Pre-Defined Class Variables
print ("\nSome Pre-Defined Variables:")
print ("__doc__:" + Movie.__doc__)
print ("__name__:" + Movie.__name__)
print ("__module__:" + Movie.__module__)
